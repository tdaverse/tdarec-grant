...
The scope of the package is to implement a lightweight data structure to host a persistence diagram. There is an [issue](https://github.com/tdaverse/tdaverse/issues/4) on the [{tdaverse}](https://github.com/tdaverse/tdaverse) repository to brainstorm for the best representation.
