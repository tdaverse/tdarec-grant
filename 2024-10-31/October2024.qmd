...
The [tidymodels](https://www.tidymodels.org) ecosystem of packages has the [{infer}](https://infer.tidymodels.org/) package which is dedicated to performing statistical inference using an expressive statistical grammar that coheres with the tidyverse design framework.
